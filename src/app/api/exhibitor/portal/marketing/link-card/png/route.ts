// Vendor-facing "Find us at CTH" link card (1200x630) PNG download.
// Ideal for WhatsApp link previews + LinkedIn / general share.
//
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[marketing/link-card] render failed:', (e as Error).message)
